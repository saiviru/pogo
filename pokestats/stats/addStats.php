<!-- Form used to add new entries of trainers in database -->
<?php
	...
	$update=$con->query("UPDATE user SET trainer_name = '$etrainer_name', kanto='$kanto', johto='$johto', hoenn='$hoenn',
		...
		if($update)
		{
			...
			if($final_update){
				...
				echo "<script type='text/javascript'> document.location = 'http://localhost/totalSetup/pokestats/stats/yourstats.php'; </script>";
			}
